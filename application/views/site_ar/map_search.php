         ...
         <section id="content-section">
              ...
              <div class="container">
                  ...
                  <div class="row contact-page">
                      ...
                      <h4 class="Property-name"> البحث بالخريطة </h4>                   
        ...
        function initMap() {
		    ...
		    for (i = 0; i < locations.length; i++) {  
		      ...
		      google.maps.event.addListener(marker, 'mouseover', (function(marker, i) {
		        return function() {
		        	var url = "<a style='padding-right: 20px;' target='_blank' href='<?= base_url('ar/properties') ?>/"+locations[i].id+"/"+locations[i].title+"' >" + locations[i].title_ar + "</a>";
